...
public class RedstoneHiroshima extends Module {
    ...
    private final Setting<RedstoneHiroshima.Mode> mode = sgGeneral.add(new EnumSetting.Builder<RedstoneHiroshima.Mode>()
        .name("mode")
    ...
    private final Setting<RedstoneHiroshima.SortMode> sortMode = sgGeneral.add(new EnumSetting.Builder<RedstoneHiroshima.SortMode>()
        .name("sort-mode")
        .description("The blocks you want to mine first.")
        .defaultValue(RedstoneHiroshima.SortMode.Closest)
        .build()
    );
    ...
    public RedstoneHiroshima() {
        super(Categories.World, "RedstoneNuker", "Breaks redstone, to keep you safe when placing TNT.");
    }
    ...
    public static double getScore(ItemStack itemStack, BlockState state, boolean silkTouchEnderChest, RedstoneHiroshima.EnchantPreference enchantPreference, Predicate<ItemStack> good) {
