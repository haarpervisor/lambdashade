...
public class ContainerFailure extends Module {
    ...
    public ContainerFailure() {
        super(Categories.Misc, "container-crash", "Lags/crashes servers by spamming container opening packets. Press escape to toggle.");
    }
